...
ifeq ($(BR2_PACKAGE_RETROARCH_AUDIO_ALSA),y)
RETROARCH_AUDIO_BACKEND = "alsa"
...
ifeq ($(BR2_PACKAGE_RETROARCH_AUDIO_PULSEAUDIO),y)
RETROARCH_AUDIO_BACKEND = "pulse"
...
ifeq ($(BR2_PACKAGE_RETROARCH_AUDIO_JACK),y)
RETROARCH_AUDIO_BACKEND = "jack"
...
ifeq ($(BR2_PACKAGE_RETROARCH_AUDIO_SDL),y)
RETROARCH_AUDIO_BACKEND = "sdl"
endif

ifeq ($(BR2_PACKAGE_DBUS),y)
RETROARCH_DEPENDENCIES += dbus
...
RETROARCH_CONFIG_OPTS += --enable-libusb
else
RETROARCH_CONFIG_OPTS += --disable-libusb
endif
...
RETROARCH_CONFIG_OPTS += --enable-pipewire
RETROARCH_DEPENDENCIES += pipewire
else
RETROARCH_CONFIG_OPTS += --disable-pipewire
endif
...
define RETROARCH_CFG_FIXUPS
	$(SED) "s%@AUDIO_DRIVER@%$(RETROARCH_AUDIO_BACKEND)%" \
		$(TARGET_DIR)/etc/retroarch.cfg
endef
RETROARCH_POST_INSTALL_TARGET_HOOKS += RETROARCH_CFG_FIXUPS
