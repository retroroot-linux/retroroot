...
class Log:
    ...
    def debug(self, message, *args, **kwargs):
        ...
        log_format = stack_info + " " + self.log_format
    ...
    def error(self, message, *args, **kwargs):
        ...
        if self.level == logging.DEBUG:
            log_format = self.__parse_stack_info(stack()) + " " + self.log_format
            self.__set_formatter(log_format)
    ...
    def __init__(self, name, verbose, custom_log_format=None,
                 file_path=None, file_level=logging.INFO, clear_log_file=False):
        ...
        if self.file_path:
            self.file_handler = logging.FileHandler(file_path, "w" if clear_log_file else "a")
